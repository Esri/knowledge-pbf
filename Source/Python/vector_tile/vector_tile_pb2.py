...
Tile = _reflection.GeneratedProtocolMessageType('Tile', (_message.Message,), {
  ...
  'Value' : _reflection.GeneratedProtocolMessageType('Value', (_message.Message,), {
    ...
    '__module__' : 'vector_tile.vector_tile_pb2'
