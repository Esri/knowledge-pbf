...
#ifndef GOOGLE_PROTOBUF_INCLUDED_vector_5ftile_2fvector_5ftile_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_vector_5ftile_2fvector_5ftile_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_vector_5ftile_2fvector_5ftile_2eproto EXT_CLASS
...
struct EXT_CLASS TableStruct_vector_5ftile_2fvector_5ftile_2eproto {
...
EXT_CLASS extern TileDefaultTypeInternal _Tile_default_instance_;
class Tile_Feature;
class Tile_FeatureDefaultTypeInternal;
EXT_CLASS extern Tile_FeatureDefaultTypeInternal _Tile_Feature_default_instance_;
class Tile_Layer;
class Tile_LayerDefaultTypeInternal;
EXT_CLASS extern Tile_LayerDefaultTypeInternal _Tile_Layer_default_instance_;
class Tile_Value;
class Tile_ValueDefaultTypeInternal;
EXT_CLASS extern Tile_ValueDefaultTypeInternal _Tile_Value_default_instance_;
}  // namespace vector_tile
PROTOBUF_NAMESPACE_OPEN
template<> EXT_CLASS ::vector_tile::Tile* Arena::CreateMaybeMessage<::vector_tile::Tile>(Arena*);
template<> EXT_CLASS ::vector_tile::Tile_Feature* Arena::CreateMaybeMessage<::vector_tile::Tile_Feature>(Arena*);
template<> EXT_CLASS ::vector_tile::Tile_Layer* Arena::CreateMaybeMessage<::vector_tile::Tile_Layer>(Arena*);
template<> EXT_CLASS ::vector_tile::Tile_Value* Arena::CreateMaybeMessage<::vector_tile::Tile_Value>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace vector_tile {
...
enum Tile_GeomType : int {
  ...
  Tile_GeomType_Tile_GeomType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  Tile_GeomType_Tile_GeomType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
EXT_CLASS bool Tile_GeomType_IsValid(int value);
...
class EXT_CLASS Tile_Value PROTOBUF_FINAL :
 ...
 private:
  ...
  friend struct ::TableStruct_vector_5ftile_2fvector_5ftile_2eproto;
};
// -------------------------------------------------------------------

class EXT_CLASS Tile_Feature PROTOBUF_FINAL :
...
class EXT_CLASS Tile_Layer PROTOBUF_FINAL :
...
class EXT_CLASS Tile PROTOBUF_FINAL :
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_vector_5ftile_2fvector_5ftile_2eproto
