...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fUpdateNamedTypeResponse_2eproto EXT_CLASS
...
struct EXT_CLASS TableStruct_esriPBuffer_2fgraph_2fUpdateNamedTypeResponse_2eproto {
...
EXT_CLASS extern GraphNamedObjectTypeUpdateResponseDefaultTypeInternal _GraphNamedObjectTypeUpdateResponse_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> EXT_CLASS ::esriPBuffer::graph::GraphNamedObjectTypeUpdateResponse* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphNamedObjectTypeUpdateResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class EXT_CLASS GraphNamedObjectTypeUpdateResponse PROTOBUF_FINAL :
