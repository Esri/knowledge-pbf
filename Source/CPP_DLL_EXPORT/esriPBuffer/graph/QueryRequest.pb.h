...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fQueryRequest_2eproto EXT_CLASS
...
struct EXT_CLASS TableStruct_esriPBuffer_2fgraph_2fQueryRequest_2eproto {
...
EXT_CLASS extern GraphQueryRequestDefaultTypeInternal _GraphQueryRequest_default_instance_;
class GraphQueryRequest_ParametersEntry_DoNotUse;
class GraphQueryRequest_ParametersEntry_DoNotUseDefaultTypeInternal;
EXT_CLASS extern GraphQueryRequest_ParametersEntry_DoNotUseDefaultTypeInternal _GraphQueryRequest_ParametersEntry_DoNotUse_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> EXT_CLASS ::esriPBuffer::graph::GraphQueryRequest* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphQueryRequest>(Arena*);
template<> EXT_CLASS ::esriPBuffer::graph::GraphQueryRequest_ParametersEntry_DoNotUse* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphQueryRequest_ParametersEntry_DoNotUse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class EXT_CLASS GraphQueryRequest PROTOBUF_FINAL :
