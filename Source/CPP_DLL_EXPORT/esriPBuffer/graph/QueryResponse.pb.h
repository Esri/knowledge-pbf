...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fQueryResponse_2eproto EXT_CLASS
...
struct EXT_CLASS TableStruct_esriPBuffer_2fgraph_2fQueryResponse_2eproto {
...
EXT_CLASS extern GraphQueryResultFrameDefaultTypeInternal _GraphQueryResultFrame_default_instance_;
class GraphQueryResultHeader;
class GraphQueryResultHeaderDefaultTypeInternal;
EXT_CLASS extern GraphQueryResultHeaderDefaultTypeInternal _GraphQueryResultHeader_default_instance_;
class GraphQueryRow;
class GraphQueryRowDefaultTypeInternal;
EXT_CLASS extern GraphQueryRowDefaultTypeInternal _GraphQueryRow_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> EXT_CLASS ::esriPBuffer::graph::GraphQueryResultFrame* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphQueryResultFrame>(Arena*);
template<> EXT_CLASS ::esriPBuffer::graph::GraphQueryResultHeader* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphQueryResultHeader>(Arena*);
template<> EXT_CLASS ::esriPBuffer::graph::GraphQueryRow* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphQueryRow>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class EXT_CLASS GraphQueryResultHeader PROTOBUF_FINAL :
...
class EXT_CLASS GraphQueryRow PROTOBUF_FINAL :
...
class EXT_CLASS GraphQueryResultFrame PROTOBUF_FINAL :
