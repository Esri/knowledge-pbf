...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fAddFieldsResponse_2eproto EXT_CLASS
...
struct EXT_CLASS TableStruct_esriPBuffer_2fgraph_2fAddFieldsResponse_2eproto {
...
EXT_CLASS extern GraphPropertyAddResultDefaultTypeInternal _GraphPropertyAddResult_default_instance_;
class GraphPropertyAddsResponse;
class GraphPropertyAddsResponseDefaultTypeInternal;
EXT_CLASS extern GraphPropertyAddsResponseDefaultTypeInternal _GraphPropertyAddsResponse_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> EXT_CLASS ::esriPBuffer::graph::GraphPropertyAddResult* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphPropertyAddResult>(Arena*);
template<> EXT_CLASS ::esriPBuffer::graph::GraphPropertyAddsResponse* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphPropertyAddsResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class EXT_CLASS GraphPropertyAddResult PROTOBUF_FINAL :
...
class EXT_CLASS GraphPropertyAddsResponse PROTOBUF_FINAL :
