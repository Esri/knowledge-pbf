...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fSearchQueryRequest_2eproto EXT_CLASS
...
struct EXT_CLASS TableStruct_esriPBuffer_2fgraph_2fSearchQueryRequest_2eproto {
...
EXT_CLASS extern GraphSearchRequestDefaultTypeInternal _GraphSearchRequest_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> EXT_CLASS ::esriPBuffer::graph::GraphSearchRequest* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphSearchRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
EXT_CLASS bool GraphSearchRequest_esriNamedTypeCategory_IsValid(int value);
...
class EXT_CLASS GraphSearchRequest PROTOBUF_FINAL :
