...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fObjectIdentifierSet_2eproto
...
struct TableStruct_esriPBuffer_2fObjectIdentifierSet_2eproto {
...
extern ObjectIdArrayDefaultTypeInternal _ObjectIdArray_default_instance_;
class ObjectIdentifierSet;
class ObjectIdentifierSetDefaultTypeInternal;
extern ObjectIdentifierSetDefaultTypeInternal _ObjectIdentifierSet_default_instance_;
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> ::esriPBuffer::ObjectIdArray* Arena::CreateMaybeMessage<::esriPBuffer::ObjectIdArray>(Arena*);
template<> ::esriPBuffer::ObjectIdentifierSet* Arena::CreateMaybeMessage<::esriPBuffer::ObjectIdentifierSet>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {

// ===================================================================

class ObjectIdArray PROTOBUF_FINAL :
...
class ObjectIdentifierSet PROTOBUF_FINAL :
