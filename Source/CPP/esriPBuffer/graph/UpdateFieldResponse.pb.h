...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fUpdateFieldResponse_2eproto
...
struct TableStruct_esriPBuffer_2fgraph_2fUpdateFieldResponse_2eproto {
...
extern GraphPropertyUpdateResponseDefaultTypeInternal _GraphPropertyUpdateResponse_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> ::esriPBuffer::graph::GraphPropertyUpdateResponse* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphPropertyUpdateResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class GraphPropertyUpdateResponse PROTOBUF_FINAL :
