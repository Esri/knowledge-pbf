...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fQueryDataModelResponse_2eproto
...
struct TableStruct_esriPBuffer_2fgraph_2fQueryDataModelResponse_2eproto {
...
extern GraphDataModelDefaultTypeInternal _GraphDataModel_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> ::esriPBuffer::graph::GraphDataModel* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphDataModel>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class GraphDataModel PROTOBUF_FINAL :
