...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fAddIndexesRequest_2eproto
...
struct TableStruct_esriPBuffer_2fgraph_2fAddIndexesRequest_2eproto {
...
extern GraphPropertyIndexAddsRequestDefaultTypeInternal _GraphPropertyIndexAddsRequest_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> ::esriPBuffer::graph::GraphPropertyIndexAddsRequest* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphPropertyIndexAddsRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class GraphPropertyIndexAddsRequest PROTOBUF_FINAL :
