...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fAddNamedTypesRequest_2eproto
...
struct TableStruct_esriPBuffer_2fgraph_2fAddNamedTypesRequest_2eproto {
...
extern GraphNamedObjectTypeAddsRequestDefaultTypeInternal _GraphNamedObjectTypeAddsRequest_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> ::esriPBuffer::graph::GraphNamedObjectTypeAddsRequest* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphNamedObjectTypeAddsRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class GraphNamedObjectTypeAddsRequest PROTOBUF_FINAL :
