...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fUpdateFieldRequest_2eproto
...
struct TableStruct_esriPBuffer_2fgraph_2fUpdateFieldRequest_2eproto {
...
extern GraphPropertyMaskDefaultTypeInternal _GraphPropertyMask_default_instance_;
class GraphPropertyUpdateRequest;
class GraphPropertyUpdateRequestDefaultTypeInternal;
extern GraphPropertyUpdateRequestDefaultTypeInternal _GraphPropertyUpdateRequest_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> ::esriPBuffer::graph::GraphPropertyMask* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphPropertyMask>(Arena*);
template<> ::esriPBuffer::graph::GraphPropertyUpdateRequest* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphPropertyUpdateRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class GraphPropertyMask PROTOBUF_FINAL :
...
class GraphPropertyUpdateRequest PROTOBUF_FINAL :
