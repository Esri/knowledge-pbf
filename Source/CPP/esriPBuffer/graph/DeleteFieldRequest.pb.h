...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fDeleteFieldRequest_2eproto
...
struct TableStruct_esriPBuffer_2fgraph_2fDeleteFieldRequest_2eproto {
...
extern GraphPropertyDeleteRequestDefaultTypeInternal _GraphPropertyDeleteRequest_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> ::esriPBuffer::graph::GraphPropertyDeleteRequest* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphPropertyDeleteRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class GraphPropertyDeleteRequest PROTOBUF_FINAL :
