...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fDataModelTypes_2eproto
...
struct TableStruct_esriPBuffer_2fgraph_2fDataModelTypes_2eproto {
...
extern GraphDocumentEntityTypeInfoDefaultTypeInternal _GraphDocumentEntityTypeInfo_default_instance_;
class GraphProperty;
class GraphPropertyDefaultTypeInternal;
extern GraphPropertyDefaultTypeInternal _GraphProperty_default_instance_;
class NamedObjectType;
class NamedObjectTypeDefaultTypeInternal;
extern NamedObjectTypeDefaultTypeInternal _NamedObjectType_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::esriPBuffer::graph::EntityType* Arena::CreateMaybeMessage<::esriPBuffer::graph::EntityType>(Arena*);
template<> ::esriPBuffer::graph::GraphDocumentEntityTypeInfo* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphDocumentEntityTypeInfo>(Arena*);
template<> ::esriPBuffer::graph::GraphProperty* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphProperty>(Arena*);
template<> ::esriPBuffer::graph::NamedObjectType* Arena::CreateMaybeMessage<::esriPBuffer::graph::NamedObjectType>(Arena*);
template<> ::esriPBuffer::graph::RelationshipType* Arena::CreateMaybeMessage<::esriPBuffer::graph::RelationshipType>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class NamedObjectType PROTOBUF_FINAL :
...
class EntityType PROTOBUF_FINAL :
...
class RelationshipType PROTOBUF_FINAL :
...
class GraphProperty PROTOBUF_FINAL :
...
class GraphDocumentEntityTypeInfo PROTOBUF_FINAL :
