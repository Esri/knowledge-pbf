...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_esriPBuffer_2fgraph_2fUpdateNamedTypeRequest_2eproto
...
struct TableStruct_esriPBuffer_2fgraph_2fUpdateNamedTypeRequest_2eproto {
...
extern GraphEntityTypeUpdateDefaultTypeInternal _GraphEntityTypeUpdate_default_instance_;
class GraphNamedObjectTypeUpdateRequest;
class GraphNamedObjectTypeUpdateRequestDefaultTypeInternal;
extern GraphNamedObjectTypeUpdateRequestDefaultTypeInternal _GraphNamedObjectTypeUpdateRequest_default_instance_;
class GraphRelationshipTypeUpdate;
class GraphRelationshipTypeUpdateDefaultTypeInternal;
extern GraphRelationshipTypeUpdateDefaultTypeInternal _GraphRelationshipTypeUpdate_default_instance_;
class NamedObjectTypeMask;
class NamedObjectTypeMaskDefaultTypeInternal;
extern NamedObjectTypeMaskDefaultTypeInternal _NamedObjectTypeMask_default_instance_;
class RelationshipTypeMask;
class RelationshipTypeMaskDefaultTypeInternal;
extern RelationshipTypeMaskDefaultTypeInternal _RelationshipTypeMask_default_instance_;
}  // namespace graph
}  // namespace esriPBuffer
PROTOBUF_NAMESPACE_OPEN
template<> ::esriPBuffer::graph::GraphEntityTypeUpdate* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphEntityTypeUpdate>(Arena*);
template<> ::esriPBuffer::graph::GraphNamedObjectTypeUpdateRequest* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphNamedObjectTypeUpdateRequest>(Arena*);
template<> ::esriPBuffer::graph::GraphRelationshipTypeUpdate* Arena::CreateMaybeMessage<::esriPBuffer::graph::GraphRelationshipTypeUpdate>(Arena*);
template<> ::esriPBuffer::graph::NamedObjectTypeMask* Arena::CreateMaybeMessage<::esriPBuffer::graph::NamedObjectTypeMask>(Arena*);
template<> ::esriPBuffer::graph::RelationshipTypeMask* Arena::CreateMaybeMessage<::esriPBuffer::graph::RelationshipTypeMask>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace esriPBuffer {
namespace graph {
...
class GraphNamedObjectTypeUpdateRequest PROTOBUF_FINAL :
...
class NamedObjectTypeMask PROTOBUF_FINAL :
...
class GraphEntityTypeUpdate PROTOBUF_FINAL :
...
class RelationshipTypeMask PROTOBUF_FINAL :
...
class GraphRelationshipTypeUpdate PROTOBUF_FINAL :
